...
// If you prefer to install them as npm packages, you would import them here:
...
export default function ConstructXLandingPage() {
  ...
  useEffect(() => {
    ...
    if (renderer.outputEncoding) { // sRGBEncoding is now outputColorSpace
        renderer.outputColorSpace = THREE.SRGBColorSpace;
    } else { // Fallback for older Three.js versions
    ...
    const createConstructionElements = () => {
        ...
        const craneTowerMaterial = new THREE.MeshPhongMaterial({ color: 0x3b82f6 });
        ...
        const craneArmMaterial = new THREE.MeshPhongMaterial({ color: 0x3b82f6 });
        ...
        for (let i = 0; i < 4; i++) {
            ...
            const workerMaterial = new THREE.MeshPhongMaterial({ color: 0x10b981 });
    ...
    return () => {
      ...
      // Cleanup Three.js scene, renderer, etc.
  ...
  return (
    <>
              ...
              <div className="flex justify-between h-20 items-center">
                  ...
                  <div className="hidden lg:block">
                      <div className="ml-10 flex items-baseline space-x-8">
                          <a href="#home" className="nav-link text-gray-900 hover:text-blue-600">Home</a>
                          <a href="#features" className="nav-link text-gray-900 hover:text-blue-600">Features</a>
                          <Link href="/tenders" className="nav-link text-gray-900 hover:text-blue-600">Tenders</Link>
                          <Link href="/labor" className="nav-link text-gray-900 hover:text-blue-600">Labor</Link>
                          <a href="#pricing" className="nav-link text-gray-900 hover:text-blue-600">Pricing</a>
                          <a href="#contact" className="nav-link text-gray-900 hover:text-blue-600">Contact</a>
                           {/* Links to other existing BhoomiLink features */}
                           <Link href="/projects" className="nav-link text-gray-900 hover:text-blue-600">Projects</Link>
                           <Link href="/material-estimation" className="nav-link text-gray-900 hover:text-blue-600">Material AI</Link>
                      </div>
                  </div>
                  <div className="hidden lg:block">
      ...
      <div id="mobile-menu" className="fixed inset-0 z-40 bg-white hidden lg:hidden">
          <div className="container h-full flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col items-center space-y-8">
                  <a href="#home" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Home</a>
                  <a href="#features" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Features</a>
                  <Link href="/tenders" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Tenders</Link>
                  <Link href="/labor" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Labor</Link>
                  <a href="#pricing" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Pricing</a>
                  <a href="#contact" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Contact</a>
                  <Link href="/projects" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Projects</Link>
                  <Link href="/material-estimation" className="text-2xl font-medium text-gray-900 hover:text-blue-600">Material AI</Link>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="feature-card">
                      ...
                      <p className="text-gray-600">
                          ...
                          <Link href="/tenders" className="text-blue-600 hover:underline block mt-2">Explore Tenders &rarr;</Link>
                      </p>
                  </div>
                  ...
                  <div className="feature-card">
                      ...
                      <p className="text-gray-600">
                          ...
                          <Link href="/labor" className="text-blue-600 hover:underline block mt-2">Manage Labor &rarr;</Link>
                      </p>
                  </div>
                  ...
                  <div className="feature-card">
                      ...
                      <p className="text-gray-600">
                          ...
                          <Link href="/boq-calculators" className="text-blue-600 hover:underline block mt-2">Use Calculators &rarr;</Link>
                          <Link href="/material-estimation" className="text-blue-600 hover:underline block mt-1">AI Material Estimation &rarr;</Link>
                      </p>
                  </div>
                  ...
                  <div className="feature-card">
                      ...
                      <p className="text-gray-600">
                          ...
                          <Link href="/market" className="text-blue-600 hover:underline block mt-2">Check Market Prices &rarr;</Link>
                      </p>
                  </div>
                  ...
                  <div className="feature-card">
                      ...
                      <p className="text-gray-600">
                          Complete financial control with accounting, billing, and cash flow management. Generate RA bills with automatic GST.
                           <Link href="/financials" className="text-blue-600 hover:underline block mt-2">Financial Guide &rarr;</Link>
                           <Link href="/gst" className="text-blue-600 hover:underline block mt-1">GST Info &rarr;</Link>
                      </p>
                  </div>
                  ...
                  <div className="feature-card">
                    ...
                    <p className="text-gray-600">
                        ...
                        <Link href="/projects" className="text-blue-600 hover:underline block mt-2">Manage Projects &rarr;</Link>
                        <Link href="/tasks" className="text-blue-600 hover:underline block mt-1">Manage Tasks &rarr;</Link>
                    </p>
                  </div>
              </div>
          </div>
      ...
      {/* Final CTA Section */}
      <section id="contact" className="section bg-gradient-to-br from-blue-600 to-green-500 py-20">
          <div className="container">
